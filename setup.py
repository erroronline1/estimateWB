...
import os
from freecad.estimate.version import __version__
# name: this is the name of the distribution.
# Packages using the same name here cannot be installed together

version_path = os.path.join(os.path.abspath(os.path.dirname(__file__)),
                            "freecad", "estimate", "version.py")
with open(version_path) as fp:
    exec(fp.read())

setup(name='freecad.estimate',
      ...
      description="estimate values for calculating production costs of your creations",
